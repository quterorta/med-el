...
@section('main-content')
    <div class="all-products-main block-plr-5 block-ptb-5">
        <div class="filters">
            ...
            <form action="{{ route('all-products') }}" id="specificationsForm">
                        ...
                        @foreach($categoriesForMenu as $category)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input"
                                       ...
                                       @if($currentCategory->id === $category->id) checked
                                       @elseif (Request::input('productCategories') && in_array($category->id, array_values(Request::input('productCategories')))) checked @endif>
